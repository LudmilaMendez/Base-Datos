...
//! EL MODEL ES EL ENCARGADO DE CONECTARSE A LA BASE DE DATOS
//! EL SERVICE HACE LA LOGICA Y USA EL MODELO PARA INTERACTUAR CON LA BD


export type UserRow = IUser & RowDataPacket; // Extiende User con RowDataPacket para compatibilidad con MySQL
...
export const createUser = async ( 
    user: Omit<IUser, 'id' | 'role'>           //?NO SE PASA NI EL ID NI EL ROL
): Promise<number> => {
